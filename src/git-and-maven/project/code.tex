...
\lstinputlisting[language=Java,float,linewidth=1.1\textwidth,caption=A simple tokenization program based on Stanford CoreNLP tool,label=java]{DependencyExample.java}
