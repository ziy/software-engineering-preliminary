...
\lstinputlisting[language=Java,float,linewidth=1.1\textwidth,caption=A simple tokenization program based on Stanford CoreNLP tool,label=java]{../lst/DependencyExample.java}
...
\begin{qa}
\item[Q1] How can I run the Java code within Eclipse? And how can I send command line arguments in Eclipse?
\item[A1] These are Eclipse/Java related questions. You can refer to \\\url{http://www.javaprogrammingforums.com/java-jdk-ide-tutorials/362-how-send-command-line-arguments-eclipse.html} or search for other similar posts or articles.
\end{qa}
