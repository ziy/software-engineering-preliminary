...
One very special descriptor is your \verb|CpeDescriptor.xml|, where is the entry
point for the entire pipeline, which means you are required to name your CPE
descriptor exactly the same way, and place it in the right place for us to
evaluate your code.
