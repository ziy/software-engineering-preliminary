...
\item and two files in the \texttt{src/main/resources/inputData} folder,
\texttt{q001.txt} and \texttt{q002.txt}, which correspond to two sample input
files.
...
\url{https://github.com/oaqa/software-engineering-hw1-archetype}, and you can
send a pull request to us regarding any issue.
